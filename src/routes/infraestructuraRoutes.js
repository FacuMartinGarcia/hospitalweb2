...
router.get('/api/habitaciones-compatibles', infraestructuraController.obtenerHabitacionesCompatibles);
router.get('/api/camas-paciente', infraestructuraController.listarCamasPorPacienteInternacion);
